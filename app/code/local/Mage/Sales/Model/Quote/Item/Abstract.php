    ...
    implements Mage_Catalog_Model_Product_Configuration_Item_Interface
{
    ...
    public function calcRowTotal()
    {
      ...
      //  Mage::log('abstrat',Zend_log::INFO,'layout.log',true);
//Mage::log($product->debug(),Zend_log::INFO,'layout.log',true);
      //     Mage::log('close',Zend_log::INFO,'layout.log',true);
    //  $appliedPrice=$this->getStore()->roundPrice($this->getCalculationPriceOriginal());
    $appliedPriceBase=  $this->getStore()->roundPrice($this->getBaseCalculationPriceOriginal());
    Mage::log($appliedPrice.' and '.$appliedPriceBase,Zend_log::INFO,'layout.log',true);
           $tempSubtotal=$appliedPriceBase* $qty*$product->getData('renttime');
             $tempSubtotal+=  $qty*$product->getData('security');
