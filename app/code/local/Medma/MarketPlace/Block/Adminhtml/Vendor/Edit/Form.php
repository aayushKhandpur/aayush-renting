...
class Medma_MarketPlace_Block_Adminhtml_Vendor_Edit_Form extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
      ...
      $profile_fieldset->addField('address', 'textarea', array(
        'name' => 'address',
        'label' => Mage::helper('adminhtml')->__('Address'),
        'title' => Mage::helper('adminhtml')->__('Address'),
      ...
      $profile_fieldset->addField('city', 'text', array(
          'name' => 'city',
      ...
      $profile_fieldset->addField('state', 'text', array(
          'name' => 'state',
      ...
      $profile_fieldset->addField('pincode', 'text', array(
          'name' => 'pincode',
