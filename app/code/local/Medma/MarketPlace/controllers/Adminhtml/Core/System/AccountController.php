...
class Medma_MarketPlace_Adminhtml_Core_System_AccountController extends Mage_Adminhtml_System_AccountController {
    ...
    public function saveAction()
    {
        ...
        try
        {
            ...
            ->setState($this->getRequest()->getParam('state', false))
            ->setPincode($this->getRequest()->getParam('pincode', false))
            ->setCategory($this->getRequest()->getParam('category', false))
            ->setAdminCommissionPercentage($this->getRequest()->getParam('admin_commission_percentage', false));
          //  Mage::log(	$profile->debug() ,Zend_log::INFO,'loadLayout.log',true);
